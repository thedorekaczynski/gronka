...
describe('booru utilities', function describeBooruUtilities() {
  test('isBooruUrl recognizes danbooru post URLs', function testIsBooruUrlRecognizesDanbooruPostURLs() {
  ...
  test('isBooruUrl recognizes e621/e926 post URLs (incl. legacy path)', function testIsBooruUrlRecognizesE621E926PostURLs() {
  ...
  test('isBooruUrl rejects non-post pages on supported hosts', function testIsBooruUrlRejectsNonPostPagesOn() {
  ...
  test('isBooruUrl rejects other hosts and lookalikes', function testIsBooruUrlRejectsOtherHostsAndLookalikes() {
